      ...
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Text as="span">Behind the ecosystem</Text>
            <Heading as="h3">
              sDeFi ecosystem unified under single token
            </Heading>
            <Text as="p">
              The ecosystem is unified under a single token - LEVIN.
              Participants within the ecosystem can utilize LEVIN
